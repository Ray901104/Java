    ...
    <section>
     <!-- container start -->
        <div class="container">
        	...
        	<table>
        	<tr>
        		<td><input type="text" value="게시글 내용" class="text" readonly="readonly"/><br/></td>
        	</tr>
        	<tr>
        		<td>댓글 목록
        			<input type="text" value="댓글내용" style="width:1100px" readonly="readonly"/></td>
        		<td><input type="button" value="삭제" class="btn2"/></td>
        	</tr>
        	<tr>
        		<td style="height:80px">댓글 작성
        			<input type="text" value="작성할 내용" style="width:1100px; height:80px"/>
        		</td>
        		<td><input type="button" value="등록" class="btn2"/></td>
        	</tr>
        	<tr>
        		<td></td>
        		<td><input type="button" value="목록" class="btn2"/></td>
        		<td><input type="button" value="수정" class="btn2"/></td>
        	</tr>
        	</table>
